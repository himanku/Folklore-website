...
const ProductCards = ({ PRODUCT }) => {
  ...
  return (
    ...
    >
      <Box
        bgImage="https://img.freepik.com/premium-photo/green-watercolor-with-white-spots-painted-textured-paper-with-watercolor-paints-different-green-color-background-backdrop-abstract-art-handmade-diy-painting_152932-2783.jpg?w=826"
        bgSize="100% 100%"
        p="15px"
      ...
      >
        ...
        <Flex justifyContent="space-between" alignItems="flex-end">
          ...
          <Box w={{ base: "15%", sm: "20%", lg: "25%" }}>
            <Image
              m="auto"
              src="https://res.cloudinary.com/djo88dwrg/image/upload/v1677070812/Folklore%20assets/search_prod1_cnt143.png"
              w="80%"
            />
          </Box>
        </Flex>
      ...
      <Box
        bgImage="https://images.ctfassets.net/5de70he6op10/4IFhnhWQZpy0mGYEQeDwyZ/7f5135fc723f65cebb8463a4a2d677b8/Dress_Toppers_Party_Live_Text.jpg?w=630&q=80&fm=jpg&fl=progressive"
        bgSize="100% 100%"
        p="15px"
        boxShadow="rgba(0, 0, 0, 0.25) 0px 14px 28px, rgba(0, 0, 0, 0.22) 0px 10px 10px"
      >
        ...
        <Flex justifyContent="space-between" alignItems="flex-end">
          ...
          <Box w={{ base: "15%", sm: "20%", lg: "25%" }}>
            <Image
              m="auto"
              src="https://icon-library.com/images/my-orders-icon/my-orders-icon-22.jpg"
              w="80%"
            />
          </Box>
        </Flex>
