      ...
      <Navbar/>
        <VStack p={8} gap={8}>
            ...
            <Grid templateColumns={{base:"repeat(1, 1fr)",md:"repeat(2, 1fr)",lg:"repeat(4, 1fr)",xl:"repeat(4, 1fr)"}}  gap={4} >
                ...
                <Flex> <Img src='https://images.ctfassets.net/5de70he6op10/7vGscCYY7VmIMK7ksaaCb6/0c698333c303336c8a4186ab82d2c43d/473929266-ls_m0_banner_c.jpg?w=630&q=80&fm=webp'/></Flex>
                <Flex> <Img src='https://images.ctfassets.net/5de70he6op10/5AHOqJRlFibi2rOS0C77aP/3e8dc2dfc62dd089f2cb2e53357a78d3/473929274-ls_m0_banner_e.jpg?w=630&q=80&fm=webp'/></Flex>
             ...
             ,<Button position={"absolute"} bottom={2}  left={{base:"40%",md:"40%",lg:"46",xl:"46%"}}>Shop now</Button>
              </Stack>
              <Stack w={"100%"} h={"600px"}>
                <HighlitedProduct/>
              </Stack>
