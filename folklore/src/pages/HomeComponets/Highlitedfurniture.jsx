  ...
  function Highlitedfurniture () {
    ...
    useEffect(()=>{
      async function fetchData() {
         let res= await axios.get(`https://vast-puce-mussel-tie.cyclic.app/sofas?page=1&limit=8`)
        // console.log(res.data)
        setDress(res.data.sofas)
      }
      fetchData();
...
export default Highlitedfurniture;